...
/*
Class for adapter to remove picture from DB - only by Manager
 */
public class RemoveAdapter extends BaseAdapter {
    ...
    public RemoveAdapter(Activity context,ArrayList<Image> imgae) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        itemView=(itemView==null)? inflater.inflate(R.layout.list_item_rem,null):itemView;
