...
/*
Class for activity to remove pictures from DB - only for manager
 */
public class RemovePhotos extends AppCompatActivity {
    ...
    public void filldata(){
        //fill the array list with the images and open the adapter for th ListView
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                //Once the user is clicking on the image the image remove and delete from DB
