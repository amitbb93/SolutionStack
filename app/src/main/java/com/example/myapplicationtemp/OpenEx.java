...
public class OpenEx extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(booktestflag.equals("book")) {//book solution
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(com.google.firebase.database.DataSnapshot dataSnapshot) {
                    //search in db the relevant data
                    ...
                    if (pic.size() == 1) { //if one pic present in this activity
                        Picasso.get().load(pic.get(0)).into(imageView);
                    } else if (pic.size() > 1) { // more then one pic move to openExs activity
